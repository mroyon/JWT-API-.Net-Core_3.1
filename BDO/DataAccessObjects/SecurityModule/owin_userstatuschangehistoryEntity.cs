...
namespace BDO.DataAccessObjects.SecurityModule
{
    ...
    public partial class owin_userstatuschangehistoryEntity : BaseEntity
    {
        ...
        [DataMember]
        [Display(Name = "userid", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userstatuschangehistory))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userstatuschangehistory), ErrorMessageResourceName = "useridRequired")]
        public Guid ? userid
        {
            get { return _userid; }
        ...
        [DataMember]
        [Display(Name = "masteruserid", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userstatuschangehistory))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userstatuschangehistory), ErrorMessageResourceName = "masteruseridRequired")]
        ...
        [DataMember]
        [Display(Name = "statuschanged", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userstatuschangehistory))]
        ...
        [DataMember]
        [MaxLength(250)]
        [Display(Name = "statusremark", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userstatuschangehistory))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userstatuschangehistory), ErrorMessageResourceName = "statusremarkRequired")]
        ...
        [DataMember]
        [MaxLength(450)]
        [Display(Name = "comment", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userstatuschangehistory))]
        ...
        [DataMember]
        [MaxLength(500)]
        [Display(Name = "extrafld", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userstatuschangehistory))]
