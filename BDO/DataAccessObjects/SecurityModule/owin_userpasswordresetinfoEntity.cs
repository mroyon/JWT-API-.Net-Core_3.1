...
namespace BDO.DataAccessObjects.SecurityModule
{
    ...
    public partial class owin_userpasswordresetinfoEntity : BaseEntity
    {
        ...
        [DataMember]
        [MaxLength(250)]
        [Display(Name = "sessionid", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userpasswordresetinfo))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userpasswordresetinfo), ErrorMessageResourceName = "sessionidRequired")]
        ...
        [DataMember]
        [Display(Name = "userid", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userpasswordresetinfo))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userpasswordresetinfo), ErrorMessageResourceName = "useridRequired")]
        public Guid ? userid
        {
            get { return _userid; }
        ...
        [DataMember]
        [Display(Name = "masteruserid", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userpasswordresetinfo))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userpasswordresetinfo), ErrorMessageResourceName = "masteruseridRequired")]
        ...
        [DataMember]
        [MaxLength(550)]
        [Display(Name = "sessiontoken", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userpasswordresetinfo))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userpasswordresetinfo), ErrorMessageResourceName = "sessiontokenRequired")]
        ...
        [DataMember]
        [MaxLength(150)]
        [Display(Name = "username", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userpasswordresetinfo))]
        ...
        [DataMember]
        [Display(Name = "isactive", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userpasswordresetinfo))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userpasswordresetinfo), ErrorMessageResourceName = "isactiveRequired")]
