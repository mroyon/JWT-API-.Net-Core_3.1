...
namespace BDO.DataAccessObjects.SecurityModule
{
    ...
    public partial class owin_userprefferencessettingsEntity : BaseEntity
    {
        ...
        [DataMember]
        [Display(Name = "userid", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userprefferencessettings))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userprefferencessettings), ErrorMessageResourceName = "useridRequired")]
        public Guid ? userid
        {
            get { return _userid; }
        ...
        [DataMember]
        [Display(Name = "masteruserid", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userprefferencessettings))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userprefferencessettings), ErrorMessageResourceName = "masteruseridRequired")]
        ...
        [DataMember]
        [Display(Name = "appformid", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userprefferencessettings))]
        [Required(ErrorMessageResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userprefferencessettings), ErrorMessageResourceName = "appformidRequired")]
        ...
        [DataMember]
        [Display(Name = "prepagesize", ResourceType = typeof(CLL.LLClasses.SecurityModule._owin_userprefferencessettings))]
